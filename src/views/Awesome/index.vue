      ...
      <div class="guide">
        <div class="top">
          <div class="title-bar-btns">
            <div class="btn" style="background-color: rgb(231,107,90);" @click="windowEmit('close')"></div>
            <div class="btn" style="background-color: rgb(241,188,25);" @click="windowEmit('max')"></div>
            <div class="btn" style="background-color: rgb(14,213,52);"  @click="windowEmit('min')"></div>
          </div>
      ...
      .top {
        ...
        div.title-bar-btns {
          ...
          div.btn {
            ...
            &:hover {
              box-shadow:inset 2px 2px 5px rgba(0,0,0,.02);
            }
